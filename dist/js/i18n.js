...
var translates = {
    es: {
      ...
      modals: {
        java: {
          microservices: "Microservicios basados en Spring Batch y Sring Boot",
          others: "Otros"
        },
        js: {
      ...
      section: {
        one: {
          role: "DESAROLLADOR DE APLICACIONES MULTIPLATAFORMA"
        },
        second: {
          title: "Acerca de mi",
          about: `<p>
        ...
        third: {
          asturias: "Langreo, Asturias, España",
        ...
        forth: {
          databasequery: "Bases de Datos y Lenguajes de Consulta",
          others: "Otros",
          programminglang: "Lenguajes de programación",
          testing: "Test",
          title: "Habilidades",
          versioncontrol: "Control de Versiones",
          webpagelang: "Lenguajes Web",
          webpagetools: "Herramientas Web"
        },
        fifth: {
          enumdesc: `
            <li>Manejo de diferentes formatos de serialización de datos, así como acceso a los mismo.</li>
            <li>Uso de bases de datos relacionales y su lenguaje de consulta.</li>
            <li>Desarrollo de interfaces con Java swing y C#.</li>
            <li>Manejo de sistemas de gestión empresarial.</li>
            <li>Desarrollo de aplicaciones android.</li>
            <li>Creación de páginas web con HTML, junto con sus estilos.</li>
            <li>Uso de XML y validar los mismos con DTD o XSD.</li>
            <li>Uso de sistemas linux.</li>
            <li>Alto nivel en desarrollo con java.</li>
          `,
        ...
        eigth: {
          ...
          description: `
            ...
            incorpora estos elementos en un marco integral que se puede utilizar para evaluar todo tipo de aprendizaje (principalmente formal, pero también informal y no formal) 
            dentro del aula a través de los logros que los estudiantes obtienen en sus módulos; un sistema que proporciona retroalimentación inmediata y accesible sobre el rendimiento 
            y el nivel de dominio adquirido y lo que se necesita aprender para progresar; un sistema que mejora la comunicación entre profesor y estudiante, y 
            también la comunicación entre estudiantes, una dimensión social del aprendizaje, que se sabe que fomenta una mayor participación en las actividades.<br><br>

            El objetivo general es comprometer a los estudiantes a cambiar su actitud hacia el aprendizaje, aumentando su motivación y, en consecuencia, 
            permitiéndoles alcanzar su máximo potencial.
          `,
          interface: "Interfaz hecha con HTML5, CSS y AngularJS para el comportamiento de la aplicación.",
    ...
    en: {
      ...
      modals: {
        java: {
          microservices: "Microservices based on Spring Batch and Sring Boot",
          others: "Others"
        },
        js: {
      ...
      section: {
        one: {
          role: "CROSS PLATFORM APPS DEVELOPER"
        },
        second: {
          title: "About me",
          about: `<p>
        ...
        third: {
          asturias: "Langreo, Asturias, Spain",
          developer: "Developer",
          title: "Experiences",
          remote: "Remote",
        ...
        forth: {
          databasequery: "Databases and Query Languages",
          others: "Otros",
          programminglang: "Programming Languages",
          testing: "Testing",
          title: "Skills",
          versioncontrol: "Version Control",
          webpagelang: "Webpage Languages",
          webpagetools: "Webpage Tools"
        },
        fifth: {
          enumdesc: `
            <li>Using differents ways to save data and also accessing that data.</li>
            <li>Using relational databases and their query language (SQL).</li>
            <li>Interface development with Java swing and C#.</li>
            <li>Managing enterprise resources plannings.</li>
            <li>Android apps development.</li>
            <li>Creating webpages with HTML, with CSS.</li>
            <li>Using XML and validating them with DTD or XSD.</li>
            <li>Using linux sistems.</li>
            <li>High level for java development.</li>
          `,
        ...
        eigth: {
          ...
          description: `
            ...
            real world experience and incorporate them into an integral framework that can be used to assess all kinds of learning 
            (formal, primarily, but also informal and non-formal) within the classroom through the achievements the students make in their modules; 
            a system that provides immediate and accessible feedback about performance and the level of mastery acquired and what needs to be learnt 
            in order to progress; a system that improves teacher-student communication, and also student-student communication, 
            a social dimension of learning, which is known to encourage deeper engagement with the activities.<br><br>

            The overall objective is committing the students to change their attitude towards learning, 
            increasing their motivation and consequently enabling them to achieve their full potential.
          `,
          interface: "Interface with HTML5 &amp; CSS and AngularJS for the behaviour of the app.",
